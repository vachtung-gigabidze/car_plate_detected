...
def main():
    carplate_img_rgb = open_img(img_path="C:\\Projects\\python\\CAR_PLATE_DETECTED\\cars\\1.jpg")
    carplate_haar_cascade = cv2.CascadeClassifier("C:\\Projects\\python\\CAR_PLATE_DETECTED\\haar_cascades\\haarcascade_russian_plate_number.xml")
